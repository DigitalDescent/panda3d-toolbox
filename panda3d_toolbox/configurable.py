...
from panda3d_toolbox import text, logging
...
class Configurable(object):
    """
    Base class for configurable objects. Used for loading preconfigured data 
    from an ini configuration file located within the application's virtual file system.
    """
    ...
    def _get_loader_name(self, section: str) -> str:
        ...
        snake_case = text.get_snake_case(section)
    ...
    def _get_setter_name(self, key: str) -> str:
        ...
        setter_name = 'set_%s' % text.get_snake_case(key)
        return setter_name
